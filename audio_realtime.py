...
# If you run this script from the project root (e.g. GoogleSpeechCommandLowFootprint/), and
# your files are GoogleSpeechCommandLowFootprint/Utils/util.py etc., then:
